export default function Card({ project }: { project: any }) {
	...
	return (
		<a href={project.link} className="flex flex-col items-center bg-wine border-[#C6AF87] hover:bg-wine/80 border-solid border-4 rounded-lg shadow md:flex-row md:max-w-xl ">
