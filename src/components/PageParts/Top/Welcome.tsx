...
const LINK_CLASS = "flex items-center gap-2 py-1.5 font-pressStart2P text-pixel-nav hover:underline";
		...
		<div className="flex flex-row justify-between w-full h-full">
			...
			<div className="flex flex-col justify-end items-center w-1/3 h-full relative z-1">
				<div className="flex flex-col items-center gap-1 pb-1 w-full">
					<p className="font-pressStart2P text-pixel-nav">{tWelcome("name")}</p>
