	...
	return (
		<div className="flex flex-col w-full h-full">
			...
			<div className="flex flex-row flex-1 min-h-0 w-full">
				...
				<div className="w-1/3 flex flex-col relative z-1">
					<form onSubmit={handleSubmit(onSubmit)} className="hidden md:flex flex-col justify-end flex-1 w-[95%] sm:w-[90%] gap-1 md:gap-2">
						...
						<div className="w-full flex flex-col justify-center">
							...
							<textarea
								...
								required
								maxLength={5000}
								className={`${inputClasses} md:h-24 lg:h-32 resize-none`}
								{...register("message")}
							/>
						</div>
