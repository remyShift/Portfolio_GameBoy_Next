...
export default async function AboutPage() {
	...
	return (
		<div className="relative flex flex-row w-full h-full">
			<h1 className="font-pressStart2P text-pretty text-center absolute left-1/2 -translate-x-1/2 w-[85%] top-10 md:top-16 lg:top-18 xl:top-18 text-xs sm:text-base md:text-2xl lg:text-3xl z-1">{t("title")}</h1>

			<div className="flex justify-center items-center w-1/3 h-full">
				<p className="font-pressStart2P text-pretty text-[0.45rem] sm:text-xs md:text-base lg:text-lg ml-4 xl:ml-8 absolute w-[55%] xl:w-1/2 left-2 z-1">{t("text")}</p>
			</div>

			<div className="w-1/3 h-full" aria-hidden="true" />

			<div className="flex flex-col justify-center items-center w-1/3 h-full sm:mt-6 md:mt-0 relative z-1">
