...
const images = {
	...
	"/projects/summary": [
		{ src: "/assets/img/sneakers.webp", alt: "Sneakers", className: "w-10 h-8 sm:w-12 sm:h-10 md:w-20 md:h-16 lg:w-24 lg:h-20" },
	...
	return (
		<div className="flex justify-center">
			...
			<div className="flex flex-col items-center justify-center w-1/3">
				...
				<img src="/assets/icons/Pointer_Down.webp" alt="Arrow" className="w-3 h-2 sm:w-4 sm:h-3 lg:w-6 lg:h-5 mb-2" />
			</div>
			{currentImages[1] && (
				<div className="flex w-1/3 items-end justify-center">
